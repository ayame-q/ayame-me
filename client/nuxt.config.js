export default {
	...
	head: {
		...
		meta: [
			...
			{ hid: "description", name: "description", content: "UI/UX Designer. 東洋大学情報連携学部(INIAD)4年 立松あやめのポートフォリオサイトです。" },
			...
			{ hid: "og:description", property: "og:description", content: "UI/UX Designer. 東洋大学情報連携学部(INIAD)4年 立松あやめのポートフォリオサイトです。" },
